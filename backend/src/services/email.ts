...
export async function sendWelcomeEmail(opts: { to: string; businessName: string }) {
  ...
  const dashboardUrl = 'https://automation-ai-system.vercel.app';
  const html = `
    <div style="font-family:sans-serif;max-width:540px;margin:0 auto;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb;">
      ...
      <div style="padding:28px;">
        <p style="font-size:15px;color:#111827;margin:0 0 20px;">Hola <strong>${opts.businessName}</strong>, tu cuenta está lista. Para empezar a recibir mensajes de WhatsApp seguí estos pasos:</p>
